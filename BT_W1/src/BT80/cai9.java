...
public class cai9 extends JFrame {
    ...
    public static cacloaicaixanh listData;

    public static caixanh selectedCate;

    public cai9(String title) {

        super(title);

        listData = new cacloaicaixanh();
    ...
    public void addMenu() {
        ...
        mnuFileOpenDataFromDisk = new JMenuItem("Open Data from dis");
    ...
    public void addControl() {
        ...
        dtmProduct.addColumn("Descriptio");
        ...
        lstCate.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent arg0) {
                ...
                selectedCate = (caixanh) lstCate.getSelectedValue();
    ...
    private void showListProductIntoTable() {
        ...
        for (raumuong p : selectedCate.getListPro()) {
    ...
    public static void updateCateList() {
        ...
        for (caixanh cate : listData.getList()) {
    ...
    private void doCreateNewCate() {
        ...
        cai9 cateUI = new cai9("Cate information");
    ...
    private void doComboboxSelected() {
        ...
        selectedCate = (caixanh) cboCateList.getSelectedItem();
    ...
    private void doWriteDataToDisk() {
        ...
        if (fc.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            rauxanh.saveData(listData, fc.getSelectedFile().getAbsolutePath());
    ...
    private void doReadDataFromDisk() {
        ...
        if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            listData = (cacloaicaixanh) rauxanh.openData(fc.getSelectedFile().getAbsolutePath());
